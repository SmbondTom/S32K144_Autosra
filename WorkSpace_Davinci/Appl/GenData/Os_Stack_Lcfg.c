...
/* User: [OsTask_swc_Init, OsTask_swc_Task] */
...
#define OS_START_SEC_STACK_OSTASK_BSW_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/* Shared Task stack: OsTask_Bsw */
/* User: [OsTask_Bsw] */
OS_STACK_DECLARE(OsCfg_Stack_OsTask_Bsw_Dyn, OS_CFG_SIZE_OSTASK_BSW_STACK);

#define OS_STOP_SEC_STACK_OSTASK_BSW_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
/*! Stack configuration data: OsTask_Bsw */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsTask_Bsw =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsTask_Bsw_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsTask_Bsw_Dyn)
};

 ...
 *********************************************************************************************************************/
  ...
  BswM_ESH_RunRequest Write_Request_ESH_RunRequest_0_requestedMode;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  (void)memset(&Write_Request_ESH_RunRequest_0_requestedMode, 0, sizeof(Write_Request_ESH_RunRequest_0_requestedMode));
  fct_status = TSC_Test_swc_Rte_Write_Request_ESH_RunRequest_0_requestedMode(Write_Request_ESH_RunRequest_0_requestedMode);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;

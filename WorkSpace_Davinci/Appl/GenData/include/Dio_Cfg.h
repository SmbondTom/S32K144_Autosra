...
/**
* @brief          Symbolic name for the channel DioChannel_D_PTB0.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_D_PTB0 ((uint16)0x0020U)

/**
* @brief          Symbolic name for the channel DioChannel_D_PTB1.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_D_PTB1 ((uint16)0x0021U)
...
/**
* @brief          Symbolic name for the channel DioChannel_LED_RED_PTD15.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LED_RED_PTD15 ((uint16)0x006fU)

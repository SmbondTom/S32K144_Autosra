...
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TMS_SW_DIO_PTA4  0
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_MCU_RESET_PTA5  1
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TDO_PTA10  2
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TDI_PTC5  3
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_JTAG_PortPin_JTAG_TCK_SWD_CLK_PTC4  4
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_LED_PortPin_LED_RED  5
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_CAN0_PortPin_CAN0_Rx  6
/** @violates @ref PORT_CFG_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define PortConfigSet_PortContainer_CAN0_PortPin_CAN0_Tx  7
